  ...
  <div class="view">
    <el-card class="compact-card">
      ...
      <el-alert
        ...
        title="Ключи используются AI-секретарём. Ротация: выше приоритет — раньше. Мёртвые ключи (401/403) выключаются автоматически, при 429/5xx ключ уходит в кулдаун на 2 минуты."
      />
